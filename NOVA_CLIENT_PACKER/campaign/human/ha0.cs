...
function initFlyer()
{
    ...
    //This flyer attempts to fly away (and fail) resulting in the player completing the mission seconds after starting the mission.
    //Force the flyer to stay.
    order(getObjectId("MissionGroup/flyerGroup/flyer1"), Shutdown, true);
}
