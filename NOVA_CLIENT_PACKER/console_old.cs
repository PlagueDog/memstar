...
{
    IDSTR_MISSING_FILE_TITLE         = 00131400, "Missing Modloader Files";
    IDSTR_MISSING_FILE_ERROR         = 00131401, "The file %s is required for the Modloader to run. Be sure you also copied the mods folder from the Modloader zip file to the Starsiege directory. It contains assets that are needed by the Modloader gui.";
    // checkforfile("./mods/gui/ml_btn_gui");
